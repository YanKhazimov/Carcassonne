...
void DeckBuilder::BuildStandardDeck(ObjectManager &objectManager, std::list<Tile> &tiles)
{
    ...
    tiles.emplace_back(std::vector<TileObject> {
                           { objectManager.GenerateTown(2, BonusType::Cloth), { {0, 0}, {2, 0}, {4, 0}, {0, 2}, {0, 4}, {4, 4} } },
                           { objectManager.GenerateRoad(1), { {2, 4} } },
                           { objectManager.GenerateRoad(1), { {4, 2} } },
    ...
    _X_(i, 2)
    tiles.emplace_back(std::vector<TileObject> {
                           { objectManager.GenerateTown(2, BonusType::Shield), { {0, 0}, {2, 0}, {0, 2} } },
    ...
    tiles.emplace_back(std::vector<TileObject> {
                           ...
                           { objectManager.GenerateTown(2, BonusType::Cloth), { {2, 0}, {4, 0}, {4, 2} } },
                           { objectManager.GenerateTown(1), { {2, 4} } }
                       }, "11.jpg", 0);
    _X_(i, 4)
    tiles.emplace_back(std::vector<TileObject> {
    ...
    tiles.emplace_back(std::vector<TileObject> {
                           ...
                           { objectManager.GenerateTown(2, BonusType::Cloth), { {0, 0}, {2, 0}, {0, 2} } },
                           { objectManager.GenerateTown(1), { {2, 4} } },
                           { objectManager.GenerateTown(1), { {4, 2} } }
                       }, "13.jpg", 0);
    tiles.emplace_back(std::vector<TileObject> {
    ...
    tiles.emplace_back(std::vector<TileObject> {
                           { objectManager.GenerateTown(2, BonusType::Shield), { {2, 0}, {2, 2}, {2, 4} } },
                           { objectManager.GenerateRoad(1), { {0, 2} } },
                           { objectManager.GenerateRoad(1), { {4, 2} } },
                           { objectManager.GenerateField(), { {0, 0} } },
                           { objectManager.GenerateField(), { {4, 0} } },
    ...
    tiles.emplace_back(std::vector<TileObject> {
                           { objectManager.GenerateTown(2, BonusType::Barrel), { {2, 0}, {4, 0}, {4, 2}, {0, 4}, {4, 4} } },
                           { objectManager.GenerateRoad(1), { {0, 2} } },
                           { objectManager.GenerateField(), { {0, 0} } },
    ...
    tiles.emplace_back(std::vector<TileObject> {
                           ...
                           { objectManager.GenerateRoad(1), { {0, 2} } },
                           { objectManager.GenerateField(), { {0, 4}, {4, 4} } },
                           { objectManager.GenerateTown(2, BonusType::Wheat), { {2, 0}, {4, 0}, {4, 2} } },
                           { objectManager.GenerateTown(1), { {2, 4} } }
                       }, "21.jpg", 90);
    tiles.emplace_back(std::vector<TileObject> {
                           { objectManager.GenerateTown(4, BonusType::Shield), { {0, 0}, {2, 0}, {4, 0}, {0, 2}, {2, 2}, {4, 2}, {0, 4}, {2, 4}, {4, 4} } }
                       }, "22.jpg", 0);
    tiles.emplace_back(std::vector<TileObject> {
                           { objectManager.GenerateField(), { {0, 0}, {2, 0}, {4, 0}, {4, 2}, {4, 4} } },
                           { objectManager.GenerateTown(2, BonusType::Shield), { {0, 2}, {0, 4}, {2, 4} } }
                       }, "23.jpg", 0);
    tiles.emplace_back(std::vector<TileObject> {
                           { objectManager.GenerateField(), { {4, 0} } },
                           { objectManager.GenerateField(), { {4, 4} } },
    ...
    tiles.emplace_back(std::vector<TileObject> {
                           ...
                           { objectManager.GenerateField(), { {4, 4} } },
                           { objectManager.GenerateRoad(1), { {4, 2} } },
                           { objectManager.GenerateTown(3, BonusType::Shield), { {0, 0}, {2, 0}, {0, 2}, {0, 4}, {2, 4} } }
                       }, "26.jpg", 270);
    */
    tiles.emplace_back(std::vector<TileObject> {
